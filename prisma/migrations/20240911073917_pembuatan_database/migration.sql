...
CREATE TABLE `transaction_detail` (
    ...
    `medecine_id` INTEGER NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE `transaction_detail` ADD CONSTRAINT `transaction_detail_medecine_id_fkey` FOREIGN KEY (`medecine_id`) REFERENCES `medecine`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
